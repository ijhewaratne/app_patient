              ...
              <CardContent>
                <div className="print-preview border border-[#EDECE8] rounded-lg p-6 bg-white">
                  ...
                  <div className="text-center border-b border-[#EDECE8] pb-4 mb-4">
                    <h3 className="font-display text-lg text-[#2C3A2B]">MindCare Clinic</h3>
                    <p className="text-xs text-[#9C9B97]">123 Galle Road, Colombo 03, Sri Lanka</p>
                    <p className="text-xs text-[#9C9B97]">Tel: +94 11 234 5678</p>
                  </div>
                  {/* Patient Info */}
